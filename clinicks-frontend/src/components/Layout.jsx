        ...
        <div className="flex min-h-screen bg-[#f8fafc]">
            ...
            <aside className="w-80 bg-white border-r border-slate-100 p-10 hidden md:flex flex-col fixed h-full shadow-sm gap-y-8">
                ...
                <nav className="flex flex-col flex-1 gap-y-6">
                    <Link
                        to="/pacientes"
                        className={`flex items-center gap-5 px-6 py-3 rounded-[1.5rem] font-bold transition-all ${isActive('/pacientes')
                    ...
                    <Link
                        to="/habitaciones"
                        className={`flex items-center gap-5 px-6 py-3 rounded-[1.5rem] font-bold transition-all ${isActive('/habitaciones')
                            ? 'text-emerald-600 bg-emerald-50 shadow-sm shadow-emerald-100/30'
                            : 'text-slate-400 hover:text-slate-600 hover:bg-slate-50'
                            }`}
                    >
                    ...
                    <Link
                        to="/internaciones"
                        className={`flex items-center gap-5 px-6 py-3 rounded-[1.5rem] font-bold transition-all ${isActive('/internaciones')
                            ? 'text-emerald-600 bg-emerald-50 shadow-sm shadow-emerald-100/30'
                            : 'text-slate-400 hover:text-slate-600 hover:bg-slate-50'
                            }`}
                    >
