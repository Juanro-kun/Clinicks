...
namespace Clinicks.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260609121922_AddSPConsultarPaciente")]
    partial class AddSPConsultarPaciente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Clinicks.Domain.Entities.Usuario", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Email = "admin",
                            Nombre = "Admin",
                            Password = "$2a$11$lDSk0KbM8UhQrtZgcaPVk.XW4QMsVczmdN27g32arYSTZrJRcWzlK",
                            Rol = 1
                        });
                });
